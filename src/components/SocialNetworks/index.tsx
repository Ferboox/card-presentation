  ...
  return (
    <div className="social_networks">
        <a href="" className="social_networks__logo">
            <img className="social_networks__logo--facebook" src="/assets/facebook.png" alt="" />
            <p className='social_networks__logo__text'>Facebook</p>
        </a>
        <a href="" className="social_networks__logo">
            <img className="social_networks__logo--instagram" src="/assets/instagram.png" alt="" />
            <p className='social_networks__logo__text'>Instagram</p>
        </a>
        <a href="" className="social_networks__logo">
            <img className="social_networks__logo--instagram" src="/assets/web.png" alt="" />
